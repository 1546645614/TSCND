...
import random
import numpy as np
from exp.exp_tscnd import Exp_Tscnd
...
parser.add_argument('--individual', type=bool, default=True, help='ignore level')


### -------  model settings --------------
parser.add_argument('--hidden-size', default=4, type=float, help='hidden channel of module')
...
parser.add_argument('--Ad', type=str, default='DCM')
...
data_parser = {
    ...
    'electricity':{'data':'electricity.csv','T':'MT_369','M':[7,7,7],'S':[1,1,1],'MS':[7,7,1]},
}
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}_{}'.format(args.model, args.data, args.features,
                ...
                args.embed, args.distil, args.mix, args.des, args.hid_dim, ii)
